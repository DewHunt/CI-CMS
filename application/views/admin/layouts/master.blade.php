        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    {{-- <div class="row page-titles sticky-page-title">
                        <div class="col-md-5 align-self-center">
                            <h4 class="text-themecolor">Fix Header Sidebar</h4>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <button type="button" class="btn btn-outline-info btn-md d-none d-lg-block m-l-5"><i class="fa fa-plus-circle"></i> Create New</button>
                            </div>
                        </div>
                    </div> --}}
