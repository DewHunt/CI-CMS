<?php
    $sessionUserInfo = $this->session->userdata('sessionUserInfo');
    // echo "<pre>"; print_r($sessionUserInfo); exit();
?>
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown u-pro">
                    ...
                    <div class="dropdown-menu dropdown-menu-right animated flipInY">
                        <!-- text-->
                        <a href="<?= base_url('user/profile/'.$sessionUserInfo->id) ?>" class="dropdown-item">
                            <i class="ti-user"></i> My Profile
                        </a>

                        <!-- text-->
                        <a href="<?= base_url('user/change_password/'.$sessionUserInfo->id) ?>" class="dropdown-item">
